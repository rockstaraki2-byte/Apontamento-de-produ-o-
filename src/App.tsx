                    ...
                    <div className="flex flex-col gap-3">
                      {orderLogs.map((log) => {
                        ...
                        switch (log.type) {
                          ...
                          case "SOLDA":
                            actionLabel = "Solda";
                            actionColor = "bg-orange-50 text-orange-800 border border-orange-200";
                            actionQty = log.quantityProcessed || 0;
                            break;
                          case "PINTURA":
                            actionLabel = "Pintura";
                            actionColor = "bg-amber-50 text-amber-800 border border-amber-200";
                            actionQty = log.quantityPainted || log.quantityProcessed || 0;
                            break;
                          case "EMBALAGEM":
                            actionLabel = "Embalado";
                            actionColor = "bg-green-50 text-green-800 border border-green-200";
                            actionQty = log.quantityPacked || log.quantityProcessed || 0;
                            break;
                          case "FATURAMENTO":
                          ...
                          case "TORNO_CNC_HENRIQUE":
                            actionLabel = "Torno CNC";
                            actionColor = "bg-sky-50 text-sky-800 border border-sky-200";
                            actionQty = log.quantityProcessed || 0;
                            break;
                          case "INJETORA":
                            actionLabel = "Injetora";
                            actionColor = "bg-teal-50 text-teal-800 border border-teal-200";
                            actionQty = log.quantityProcessed || 0;
                            break;
                          case "MONTAGEM_RETRATIL":
                            actionLabel = "Montagem";
                            actionColor = "bg-purple-50 text-purple-800 border border-purple-200";
                            actionQty = log.quantityProcessed || 0;
                            break;
                        }
                  ...
                  >
                    {(() => {
                      const renderOrderCard = (codeToPrint: string) => {
                        let groupOrders = db.orders.filter(
                          (o) =>
                            o.orderCode === codeToPrint &&
                            o.status !== "CANCELADO",
                        );
                        if (groupOrders.length === 0) {
                          groupOrders = db.orders.filter(
                            (o) => o.orderCode === codeToPrint,
                          );
                        }
                        ...
                        if (orderCodesToPrintList.length >= 1) {
                          ...
                          const ord = db.orders.find(
                            (o) =>
                              o.orderCode === code &&
                              o.status !== "CANCELADO",
                          ) || db.orders.find((o) => o.orderCode === code);
